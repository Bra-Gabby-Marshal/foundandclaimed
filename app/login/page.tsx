      ...
      <div className="w-full max-w-md rounded-3xl bg-white p-10 shadow-2xl md:p-12">
        ...
        <form onSubmit={handleSubmit} className="grid gap-6" noValidate>
          ...
          <button
            type="submit"
            disabled={loading}
            className="rounded-full bg-[var(--accent)] py-4 font-bold text-white shadow-lg transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-70 cursor-pointer"
          >
